    ...
    <div class="min-h-screen bg-gray-50 flex items-center justify-center py-10 px-4">
        <div class="w-full max-w-xl">
            ...
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Edit Supplier</h1>
                <p class="text-sm text-gray-400 mt-1">Perbarui informasi supplier <span class="text-gray-600 font-medium">{{ $data->nama }}</span></p>
            </div>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            ...
                            <textarea name="alamat" rows="2"
                                ...
                                placeholder="Contoh: Jl. Industri No. 5, Kawasan MM2100">{{ old('alamat', $data->alamat) }}</textarea>
                        </div>
                        @error('alamat')
                            <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-8">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="tel" name="no_telpon" value="{{ old('no_telpon', $data->no_telpon) }}"
                                    class="w-full border border-gray-200 rounded-xl pl-10 pr-4 py-3 text-sm text-gray-800 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent transition"
            ...
            <p class="text-center text-xs text-gray-400 mt-6">Perubahan tersimpan otomatis ke sistem supplier</p>
        </div>
    </div>
</x-app-layout>