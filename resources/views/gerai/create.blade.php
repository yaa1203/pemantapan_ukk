    ...
    <div class="min-h-screen bg-gray-50 flex items-center justify-center py-10 px-4">
        <div class="w-full max-w-xl">
            ...
            <div class="mb-8">
                ...
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Tambah Gerai</h1>
                <p class="text-sm text-gray-400 mt-1">Isi form di bawah untuk mendaftarkan gerai baru</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                <form method="POST" action="/gerai">
                    ...
                    {{-- NAMA GERAI --}}
                    <div class="mb-5">
                        <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Nama Gerai</label>
                        <div class="relative">
                            ...
                            <input type="text" name="nama" value="{{ old('nama') }}"
                                ...
                                placeholder="Contoh: Gerai Utama Jakarta" required>
                        </div>
                        @error('nama')
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            ...
                            <textarea name="alamat" rows="2"
                                ...
                                placeholder="Contoh: Jl. Sudirman No. 12, Jakarta Pusat" required>{{ old('alamat') }}</textarea>
                        </div>
                        @error('alamat')
                            <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                        @enderror
            ...
            <p class="text-center text-xs text-gray-400 mt-6">Data tersimpan otomatis ke sistem toko</p>
        </div>
    </div>
</x-app-layout>